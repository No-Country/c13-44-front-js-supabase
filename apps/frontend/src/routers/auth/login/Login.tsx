...
import { object, string, minLength, maxLength, Input as Inputvali, email } from "valibot";
...
const Login = ({ setToken }: {setToken: (data: any) => void}): JSX.Element => { //Proporcionamos tipo any a setToken en las props 
  const {
    register,
    handleSubmit,
