...
export default function UsuarioPerfil({ token }: PerfilToken) {
    ...
    <>
      <div className="container">
        <div className="flex gap-[2rem]">
          <Button onClick={handleLogout} color="danger" variant="bordered" startContent={<IconLogout />} />
        ...
        <div className="flex flex-row gap-4 justify-between items-center pt-[1rem]">
          <div className="flex justify-start items-start">
            ...
            <div className="flex flex-col pl-[2rem] ">
              <h1>Bienvenido {token.user.user_metadata.user_name}</h1>
              <p>Correo: </p>
            </div>
          </div>
            ...
            <Tabs variant="underlined" aria-label="Tabs variants">
              <Tab title="Info">
                ...
                <div className="flex justify-between">
                  ...
                  <h1
                    className="font-bold text-2xl mt-[2rem]"
                  >
                    Mis Avisos
                  </h1>
                  <Button color="primary" variant="bordered" className="m-4 w-[15rem]" onClick={() => setLocation("/postvivienda")}>
                    Crear Aviso
                  </Button>
                </div>
                <Divider />
              ...
              <Tab title="Editar perfil">
                <div className="grid grid-cols-3 gap-4 mt-4">
                  ...
                  <Button color="primary" variant="bordered" className="m-2 mt-7 w-[25rem]">
                    Actualizar
                  </Button>
                </div>
              </Tab>
