...
import { minLength, object, string, number, date, minValue, maxValue, boolean, Input as Inputvali, maxLength, } from 'valibot'
...
export function Post({ token }: PerfilToken) {
                    ...
                    <div className="flex flex-col gap-4 justify-start ml-[2rem] mt-[8rem]">
                        ...
                        <div className="flex w-full flex-wrap md:flex-nowrap mb-6 md:mb-0 gap-4">
                            ...
                            >
                                {tiposDeVivienda.map((tipo) => (
                                    <SelectItem key={tipo} value={tipo} {...register("tiposDeVivienda")}                                >
                        ...
                        <div className="flex flex-col ">
                            ...
                            <div className="flex justify-end mt-[1rem]">
                                <Button type="submit" color="primary" variant="bordered" className="w-[12rem] h-[3rem]">
                                    Crear aviso
                                </Button>
                            </div>
                        </div>
